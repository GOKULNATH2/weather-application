...
export class AppComponent implements AfterViewInit {
  ...
  public marker: any = [{ text: "Lanion", img: "../assets/partly_cloudy.png", lat: 48.7333, lon: -3.4667 }, { text: "Rennes", img: "../assets/cloudy.png", lat: 48.11, lon: -1.6833 }];
  ...
  ngAfterViewInit(): void {
    ...
    setTimeout(() => {
      this.marker = [{ text: "Brest", img: "../assets/partly_cloudy.png", lat: 48.390394, lon: -4.486076 }, { text: "Lanion", img: "../assets/partly_cloudy.png", lat: 48.7333, lon: -3.4667 }, { text: "Rennes", img: "../assets/cloudy.png", lat: 48.11, lon: -1.6833 }];
    }, 5000)
  }
